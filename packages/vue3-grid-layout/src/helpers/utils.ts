 ...
 */
export function moveElement (layout: Layout, l: LayoutItem, x: number | undefined, y: number | undefined, isUserAction: boolean, preventCollision?: boolean): Layout {
...
export function sortLayoutItemsByRowCol (layout: Layout): Layout {
  return ([] as Layout).concat(layout).sort(function (a, b) {
    if (a.y === b.y && a.x === b.x) {
      return 0
    }
